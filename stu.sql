...
CREATE TABLE `car` (
  ...
  PRIMARY KEY (`id`),
  KEY `car_fk` (`pid`),
  CONSTRAINT `car_fk` FOREIGN KEY (`pid`) REFERENCES `sama` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cls` VALUES (1,'Abby',17,'w',86),(2,'Tom',18,'m',77),(3,'Alex',18,'m',84.5),(4,'Lucy',17,'w',81),(5,'elen',17,'m',90);
...
INSERT INTO `dept` VALUES (1,'技术部'),(2,'财务部'),(3,'销售部'),(4,'行政部');
...
INSERT INTO `interests` VALUES (1,'Tom','dance',16800.00,'12345678987','练舞奇才'),(2,'Lucy','sing',20000.00,'19876543212','天籁之音');
...
INSERT INTO `marathon` VALUES (1,'尼古拉斯','1996-10-12','2019-12-12 19:20:03','02:18:54'),(2,'曹操','2000-01-01','2020-01-01 15:15:25','02:10:13'),(3,'爱丽丝','2000-02-29','2020-02-06 10:15:25','02:40:01'),(4,'刘备','1995-04-21','2020-03-29 17:21:41','02:20:18');
...
--
-- Temporary table structure for view `person_dept`
--

DROP TABLE IF EXISTS `person_dept`;
/*!50001 DROP VIEW IF EXISTS `person_dept`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `person_dept` AS SELECT 
 1 AS `id`,
 1 AS `name`,
 1 AS `age`,
 1 AS `sex`,
...
--
-- Table structure for table `sama`
--

DROP TABLE IF EXISTS `sama`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sama` (
  `id` varchar(32) NOT NULL,
...
--
-- Dumping data for table `sama`
--

LOCK TABLES `sama` WRITE;
/*!40000 ALTER TABLE `sama` DISABLE KEYS */;
INSERT INTO `sama` VALUES ('1','张三','男',20);
/*!40000 ALTER TABLE `sama` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Final view structure for view `person_dept`
--
...
/*!50001 VIEW `person_dept` AS (select `p`.`id` AS `id`,`p`.`name` AS `name`,`p`.`age` AS `age`,`p`.`sex` AS `sex`,`p`.`salary` AS `salary`,`d`.`dname` AS `dname` from (`person` `p` left join `dept` `d` on((`p`.`dept_id` = `d`.`id`)))) */;
...
-- Dump completed on 2020-04-01 16:03:30
